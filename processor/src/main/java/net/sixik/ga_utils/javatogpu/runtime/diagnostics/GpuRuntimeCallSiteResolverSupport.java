...
/**
 * Domain implementation support for resolving runtime stack frames against generated GPU call-site metadata.
 */
public final class GpuRuntimeCallSiteResolverSupport {

    public static final String RESOURCE_PREFIX = "META-INF/javatogpu/call-sites/";

    private static final String ROOT_RESOLVER_CLASS = "net.sixik.ga_utils.javatogpu.runtime.GpuRuntimeCallSiteResolver";

    private GpuRuntimeCallSiteResolverSupport() {
    }

    /**
     * Resolves the current runtime stack frame to generated call-site metadata when available.
     */
    ...
    /**
     * Loads generated call-site metadata for a caller class.
     */
    ...
    /**
     * Returns the classpath resource path for generated call-site metadata.
     */
    ...
    private static boolean skipFrame(StackTraceElement frame, IrGpuSourceLocation gpuMethodLocation) {
        ...
        if (className.equals(Thread.class.getName())
                || className.equals(GpuRuntimeCallSiteResolverSupport.class.getName())
                || className.equals(ROOT_RESOLVER_CLASS)
