...
/**
 * Compatibility facade for the built-in mix peephole rule.
 *
 * @deprecated use {@link net.sixik.ga_utils.javatogpu.runtime.optimization.GpuRuntimeMixPeepholeRule}.
 */
@Deprecated
public final class GpuRuntimeMixPeepholeRule implements GpuRuntimeIrPeepholeRule {

    public static final String RULE_ID =
            net.sixik.ga_utils.javatogpu.runtime.optimization.GpuRuntimeMixPeepholeRule.RULE_ID;
    public static final String VERSION =
            net.sixik.ga_utils.javatogpu.runtime.optimization.GpuRuntimeMixPeepholeRule.VERSION;

    private final net.sixik.ga_utils.javatogpu.runtime.optimization.GpuRuntimeMixPeepholeRule delegate =
            new net.sixik.ga_utils.javatogpu.runtime.optimization.GpuRuntimeMixPeepholeRule();
