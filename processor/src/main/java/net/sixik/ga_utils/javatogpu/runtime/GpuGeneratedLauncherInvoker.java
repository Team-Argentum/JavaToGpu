 ...
 *
 * <p>Most application code should call generated launcher methods directly. This helper is useful for frameworks,
 * examples, tests, scripting layers, and method-test tooling that discover {@code @GPU} methods dynamically and need a
 * stable runtime API instead of constructing generated launcher class names by hand.</p>
 *
 * <p>Methods in this class intentionally mirror the generated launcher method families: default launch,
 * explicit global size, explicit {@link GpuExecutionConfig}, compile options, standard backend/device preflight, and
 * return-first convenience. All invocations still route through the generated launcher descriptor and the active
 * {@link GpuRuntime} backend.</p>
 */
public final class GpuGeneratedLauncherInvoker {
    ...
    /**
     * Resolves and caches the generated launcher binding for repeated calls.
     */
    ...
    /**
     * Invokes the generated launcher default method using the launch shape generated by the processor.
     */
    ...
    /**
     * Invokes the generated launcher with an explicit 1D global work size.
     */
    ...
    /**
     * Invokes a generated return-first helper and returns the boxed primitive result.
     *
     * <p>This is available only for kernels where the processor generated return-first metadata, currently the narrow
     * single read-write primitive output-array shape. Use {@link #returnValueConvenience(Class, String)} to inspect the
     * status without invoking.</p>
     */
    ...
    /**
     * Typed variant of {@link #invokeReturningFirst(Class, String, Object...)} with an early return-type check.
     */
    ...
    /**
     * Invokes the generated launcher with an explicit cross-backend launch configuration.
     */
    ...
    /**
     * Invokes the generated launcher with compile options such as artifact dumping, optimizer policy, or preflight.
     */
    ...
    /**
     * Runs standard backend/device preflight for this call and invokes with the selected backend scope.
     */
    ...
    /**
     * Returns the descriptor embedded in the generated launcher without executing the kernel.
     */
    ...
    /**
     * Returns processor-generated metadata that explains whether return-first convenience is available.
     */
    ...
    public static final class GeneratedLauncher {
        ...
        /**
         * Resolves a generated launcher once and exposes instance methods for repeated reflective invocations.
         */
        ...
        /**
         * Original class that owns the annotated GPU method.
         */
        ...
        /**
         * Original annotated method name used to resolve the generated launcher.
         */
        ...
        /**
         * Generated launcher class resolved for this owner/method pair.
         */
        ...
        /**
         * Invokes the generated launcher default method.
         */
        ...
        /**
         * Returns the kernel descriptor embedded in the generated launcher.
         */
        ...
        /**
         * Returns return-first helper availability metadata for this launcher.
         */
