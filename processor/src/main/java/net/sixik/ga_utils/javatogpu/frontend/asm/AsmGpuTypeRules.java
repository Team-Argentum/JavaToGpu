...
import net.sixik.ga_utils.javatogpu.api.pointers.BytePtr;
import net.sixik.ga_utils.javatogpu.api.pointers.CharPtr;
import net.sixik.ga_utils.javatogpu.api.pointers.DoublePtr;
...
import net.sixik.ga_utils.javatogpu.api.pointers.IntPtr;
import net.sixik.ga_utils.javatogpu.api.pointers.LongPtr;
import net.sixik.ga_utils.javatogpu.api.images.Sampler;
import net.sixik.ga_utils.javatogpu.api.pointers.ShortPtr;
