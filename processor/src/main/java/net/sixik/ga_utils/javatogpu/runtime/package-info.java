 ...
 * {@link net.sixik.ga_utils.javatogpu.runtime.GpuRuntimePackageTaxonomy} and use a domain package such as
 * {@code runtime.selection}, {@code runtime.launch}, {@code runtime.diagnostics}, {@code runtime.observability},
 * {@code runtime.methodtest}, {@code runtime.optimization}, {@code runtime.memory}, or {@code runtime.spi} unless it is a
 * deliberate compatibility entry point.</p>
 */
