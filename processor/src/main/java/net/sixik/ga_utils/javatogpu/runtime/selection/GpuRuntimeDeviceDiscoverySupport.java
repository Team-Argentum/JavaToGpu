...
/**
 * Implementation support for backend/device discovery domain APIs.
 *
 * <p>This class is intentionally separate from the root-runtime compatibility facade. New selection-focused runtime
 * code should call this package, while existing callers can keep using {@code runtime.GpuRuntimeDeviceDiscovery}.</p>
 */
public final class GpuRuntimeDeviceDiscoverySupport {

    private GpuRuntimeDeviceDiscoverySupport() {
    }
